...
프롤로그를 읽고, 내가 어떻게 개발자가 되었는지 다시 생각해보았습니다. 저자는 [거의 모든 IT의 역사](/blog/book/ithistory)에서 언급됐던 것처럼 PC가 막 보급되던 때, 우연히 컴퓨터를 접하게 되고 컴퓨터와 사랑에 빠져 청계천과 용산 전자상가를 누비며 개발자의 꿈을 키워온... 전형적인 중년의 개발자 스토리의 주인공이었습니다. 개발이 3D 업종으로 취급받던 때에도, 지금처럼 각광받던 때에도 환경에 휩쓸리지 않고 컴퓨터를 사랑하는 마음으로 '지속가능한 개발 라이프'를 꿈꾸며 살아가고 계시는 모습을 보면서 '나는 사실 프로그래밍에 대해서 이 정도의 추억, 낭만, 열정 같은 건 없는데... 계속 해도 되는 걸까?' 라는 생각이 들었습니다. 
