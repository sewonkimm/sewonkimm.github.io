...
1. 2026.06 - 리더십 연습; 한기용
2. 2026.04 - 미친 성장; 김형진
3. 2026.02 - 스마트 브레비티; 짐 밴더하기 🧡
4. 2026.01 - 실패는 나침반이다; 한기용


<details>
<summary>2025(9)</summary>
1. 2025.08 - 위임의 기술; 김진영
2. 2025.08 - 결국 문제를 뚫고 성장하는 사람; 서현직 🧡
3. 2025.08 - 이공계 X의 글쓰기책; 유키 히로시
4. 2025.06 - 소스코드: 더 비기닝; 빌 게이츠
5. 2025.03 - 데이터 스토리; 낸시 두아르테
6. 2025.03 - 나의 첫 커리어 브랜딩; 백종화
7. 2025.02 - 업무 시각화; 도미니카 드그란디스
8. 2025.01 - 일의 감각; 조수용
9. 2025.01 - [함께 자라기](./Review/growupTogether.mdx); 김창준 🧡
</details>
...
3. 2024.11 - 면접의 질문들; 김형석 🧡
4. 2024.09 - 나는 네이버 프런트엔드 개발자입니다; 김지한, 하성욱, 장기효, 윤정현, 손찬욱, 김다현, 박재성, 윤영제
5. 2024.09 - 애자일 개발이 처음인 내가 출근했더니 스크럼 마스터가 된 건에 관하여; 니시무라 나오토, 나가세 미호, 요시바 류타로
6. 2024.08 - 프로그래머의 길, 멘토에게 묻다; 데이브 후버
7. 2024.04 - 익스트림 프로그래밍; Cynthia Andres, Kent Beck
8. 2024.04 - 리액트 훅을 활용한 마이크로 상태 관리; 다이시 카토
9. 2024.02 - [소프트 스킬](./Review/softSkill.mdx); 존 손메즈
10. 2024.01 - 애자일 & 스크럼 프로젝트 관리; 이재왕
</details>
